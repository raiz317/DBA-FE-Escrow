...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/85 backdrop-blur-navbar border-b border-border px-4 sm:px-6 lg:px-8">
      <div className="max-content h-[60px] flex items-center justify-between">
        {/* Logo */}
